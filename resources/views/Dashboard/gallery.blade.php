...
<script>
    ...
    <div class="image-container">
        ...
        @csrf
            ...
            <input type="text" id="hostelName" readonly  value="{{ $hostel->name }}" name="hostelName" placeholder="Enter Hostel Name" required>
            @error('hostelName')
            <span style="color: red;">{{ $message }}</span>
        @enderror
            <label for="heading">Location:</label>
            <input type="text" id="heading" readonly value="{{ $hostel->location }}" name="location" placeholder="Enter Hostel Location" required>
            @error('location')
            <span style="color: red;">{{ $message }}</span>
        @enderror
